...
// typedef std::shared_ptr<Dyninst::InstructionAPI::Expression> DAPIExpr;
...
// 
//    public:
//     FlagSettingInstr(InstrInfoPtr &info) : m_IOI(info) {}
//     ~FlagSettingInstr() {}
//     virtual bool calc_sflag(void) = 0;
//     virtual bool calc_zflag(void) = 0;
// };
enum FLAG_STAT
{
    FLAG_CLEAR      = false ,
